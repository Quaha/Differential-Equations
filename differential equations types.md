...
### Уравнения, сводящиеся к однородному дифференциальному уравнению (Св. к ОУ) [ДОПИСАТЬ]:
...
1. Они совпадают, то имеем (УРП)
2. Они параллельны, то имеем ...
3. Они пересекаются в точке $(x_0, y_0)$: заменой сдвинем точку пересечения в начало координат, получим (ОУ)
